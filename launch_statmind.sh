#!/usr/bin/env bash
# =====================================================================
# StatMind AI — Universal One-Click Production Launcher (Linux/macOS)
# =====================================================================

set -e

echo -e "\033[0;36m=====================================================================\033[0m"
echo -e "\033[1;37m         StatMind AI — Universal Production Launcher\033[0m"
echo -e "\033[0;36m=====================================================================\033[0m\n"
...
echo -e "\n\033[1;32m[2/2] Launching StatMind AI Unified Server on port 8000...\033[0m"
echo -e "\033[1;30m---------------------------------------------------------------------\033[0m"
echo -e "  -> Local Access:   \033[1;36mhttp://localhost:8000\033[0m"
echo -e "  -> Network Access: \033[1;36mhttp://${LAN_IP}:8000\033[0m"
echo -e "\033[1;30m---------------------------------------------------------------------\033[0m"
echo -e "\033[1;33mStatMind AI is now running universally! Press Ctrl+C to stop.\033[0m\n"
