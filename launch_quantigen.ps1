# =====================================================================
# Quantigen AI — Universal One-Click Production Launcher (Windows)
# =====================================================================

Write-Host "`n=====================================================================" -ForegroundColor Cyan
Write-Host "         Quantigen AI — Universal Production Launcher" -ForegroundColor White
Write-Host "=====================================================================`n" -ForegroundColor Cyan
...
Write-Host "`n[2/2] Launching Quantigen AI Unified Server on port 8000..." -ForegroundColor Green
...
Write-Host "---------------------------------------------------------------------" -ForegroundColor DarkGray
Write-Host "Quantigen AI is now running universally! Press Ctrl+C to stop.`n" -ForegroundColor Yellow
